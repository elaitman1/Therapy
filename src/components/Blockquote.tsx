...
const BlockquoteWithImage: FC<
  PropsWithChildren<{
    author: { name: string; role: string }
    className?: string
    image: ImagePropsWithOptionalAlt
  }>
> = ({ author, children, className, image }) => {
  return (
    <figure
      className={clsx(
...
const BlockquoteWithoutImage: FC<
  PropsWithChildren<{
    author: { name: string; role: string }
    className?: string
  }>
> = ({ author, children, className }) => {
  return (
...
export const Blockquote = (
  props:
    | ComponentPropsWithoutRef<typeof BlockquoteWithImage>
    | (ComponentPropsWithoutRef<typeof BlockquoteWithoutImage> & {
        image: undefined
      })
): ReactElement => {
  if (props.image != null) {
